...
| <a name="input_endpoint_type"></a> [endpoint\_type](#input\_endpoint\_type) | n/a | `string` | `"REGIONAL"` | no |
...
| <a name="input_openapi_config"></a> [openapi\_config](#input\_openapi\_config) | n/a | `any` | `{}` | no |
