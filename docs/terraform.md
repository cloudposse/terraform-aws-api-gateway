...
| <a name="input_existing_api_gateway_rest_api"></a> [existing\_api\_gateway\_rest\_api](#input\_existing\_api\_gateway\_rest\_api) | A flag to use existing api gateway rest api to apply the aws\_api\_gateway\_rest\_api\_policy.this resource against. | `bool` | `false` | no |
