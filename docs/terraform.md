...
| <a name="minimum_compression_size"></a> [minimum\_compression\_size](#minimum\_compression\_size) | The minimum size of a response payload before it is compressed, in bytes. See https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-enable-compression.html | `number` | `null` | no |
